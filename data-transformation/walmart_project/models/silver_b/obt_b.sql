{% set configs = [
    ...
    {
        "table": "walmart.silver.customers_t",
        "columns":
        """
            c.customer_id,
    ...
    {
        "table": "walmart.silver.order_items_t",
        "columns":
        """
            oi.order_item_id,
            oi.quantity,
    ...
    {
        "table": "walmart.silver.products_t",
        "columns":
        """
            p.product_id,
            p.product_name,
    ...
    {
        "table": "walmart.silver.employees_t",
        "columns":
        """
            e.employee_id,
